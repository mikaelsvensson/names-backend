...
class DbUserRepositoryTest {
    ...
    static void beforeAll() throws LiquibaseException, UserException, SQLException {
        ...
        userRepository = new DbUserRepository(jdbcTemplate, mock(ApplicationEventPublisher.class));
        ...
        votesRepository = new DbVotesRepository(jdbcTemplate, mock(ApplicationEventPublisher.class));
        relationshipsRepository = new DbRelationshipsRepository(jdbcTemplate, mock(ApplicationEventPublisher.class));
